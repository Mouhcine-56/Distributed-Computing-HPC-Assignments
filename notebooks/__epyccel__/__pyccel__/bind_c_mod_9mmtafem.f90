!........................................
function solve_2d_burger_pyccel(n0_u, n1_u, u, n0_un, n1_un, un, n0_v, &
      n1_v, v, n0_vn, n1_vn, vn, nt, dt, dx, dy, nu) bind(c) result( &
      Out_0001)

  use mod_9mmtafem, only: mod_solve_2d_burger_pyccel => &
  ...
  Out_0001 = mod_solve_2d_burger_pyccel(u, un, v, vn, nt, dt, dx, dy, nu &
      )
